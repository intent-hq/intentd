...
pub use model::{
    ...
    GitBranches, GitCommitResult, GitFileStatus, GitMergeConflicts, GitStatus, KnownRepo, Memory,
    ...
    NoteUpdateInput, NoteUpdateMetadataResult, NoteVisibility, ProjectType, PullRequestInfo,
