...
pub use model::{
    ...
    CommentThread, CommentThreadSummary, CommentType, CommentWire, ContentType, ContextItem, Draft,
    ...
    SessionStats, SetupScript, SetupScriptGeneratedBy, SuggestionDiff, TaskAgentLink,
