...
//! `system.status` → `protocolVersion`. Version 2.2 adds `system.importLegacy`,
//! covering 296 dispatchable method names (263 router + 31 fast-path + 2
//! aliases) + 1 notification + 4 reverse RPCs.
