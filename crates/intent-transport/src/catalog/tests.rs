...
///
/// Execution environments (protocol 10.4): +4 router methods
/// (`sandbox.profiles.list` / `sandbox.profiles.update` / `sandbox.options` /
/// `sandbox.image.check`) on top of the 10.3 catalog (367).
const EXPECTED_TOTAL_METHODS: usize = 371;
...
const EXPECTED_ROUTER_METHODS: usize = 320;
