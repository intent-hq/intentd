...
/// Additional workspace management and shared execution methods for current host
/// members. Host/account administration and collaboration credentials stay excluded.
