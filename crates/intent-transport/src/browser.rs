...
//! dispatches an FE-served reverse RPC (`browser.exec` in the `rev-<n>`
//! namespace, mirroring `host.openInEditor` / `host.pickApplication`) and
//! echoes the FE's result back to the caller.
//!
