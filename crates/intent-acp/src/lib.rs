...
pub use mcp_server::{
    bindings_prelude, bindings_prelude_for, make_workspace_host, make_workspace_host_for,
    SpecialistModelOption, SpecialistModelOptions, ToolDef, WorkspaceMcpServer,
