...
mod tests {
    ...
    fn script_completion_recipe_matches_both_variants_and_follows_hook_gate() {
        ...
        const SERVICE_CAVEAT: &str = "A service-mode script's `exited` is NOT final on its own";
