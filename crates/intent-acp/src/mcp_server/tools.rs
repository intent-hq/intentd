...
mod tests {
    ...
    // The snapshot help documents `prs`: the field in the signature, the
    // grouping semantics, and the known-git-roots-only sourcing rule.
    #[test]
