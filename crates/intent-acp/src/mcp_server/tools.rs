...
static ALL_TOOLS: &[ToolDef] = &[
    ...
    // arc; the discrete tools are removed in WSAPI-8. The description mirrors
    // the reference `workspace-js-api-tool.ts` prose, adjusted to the
    // actually-bound surface — see `WORKSPACE_API_DESCRIPTION`.
    ToolDef {
        name: "workspace_api",
...
#[cfg(test)]
mod tests {
    use super::WORKSPACE_API_DESCRIPTION;
