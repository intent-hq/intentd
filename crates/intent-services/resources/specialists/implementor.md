...
4. **Shared checkout discipline**: when other agents use the same checkout, do your work on a feature branch cut from latest main and never leave uncommitted changes on a branch others may switch to.
