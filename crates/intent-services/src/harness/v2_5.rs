//! Harness v2.5 adds plain-language guidance for questions and attention requests.

use super::{Doctrine, HarnessEntry};

static DOCTRINE: Doctrine = Doctrine {
    instructions: &crate::instructions::V2_5,
...
mod tests {
    ...
    fn plain_language_reaches_interactive_roles_even_without_attention_tools() {
        let previous = super::super::resolve_entry("2.4");
        let current = super::super::latest_entry();
        assert_eq!(current.version, "2.5");
